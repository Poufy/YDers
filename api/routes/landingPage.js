...
router.get("/", (req, res) => {
  getTeacherCounts(subjectsMap => {
    res.render("landingPage", { map: subjectsMap }); //This is only a temporary solution since this slows down the load time of the website because it needs to wait for the objects to load.
  });
});
